...
var (
	...
	ErrUserAlreadyExist             = errors.New("user with this email or username already exists")
	ErrModeratorRequestAlreadyExist = errors.New("you have already requested moderator role")
